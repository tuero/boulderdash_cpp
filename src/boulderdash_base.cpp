...
auto BoulderDashGameState::operator==(const BoulderDashGameState& other) const -> bool {
    return rows == other.rows && cols == other.cols && agent_idx == other.agent_idx &&
           ...
           magic_wall_steps_remaining == other.magic_wall_steps_remaining && gems_collected == other.gems_collected &&
           magic_wall_steps == other.magic_wall_steps && blob_max_size == other.blob_max_size &&
           butterfly_explosion_ver == other.butterfly_explosion_ver && butterfly_move_ver == other.butterfly_move_ver &&
           gravity == other.gravity && disable_explosions == other.disable_explosions &&
